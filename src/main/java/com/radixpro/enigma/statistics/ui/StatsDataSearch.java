...
public class StatsDataSearch {
   ...
   private void defineLeafs() {
      lblTitle = new LabelBuilderObs("ui.stats.datasearch.lbltitle").setPrefWidth(INPUT_WIDTH).setStyleClass("titletext").build();
      lblInstruction = new LabelBuilderObs("ui.stats.datasearch.lblinstruction").setPrefWidth(INPUT_WIDTH).build();
